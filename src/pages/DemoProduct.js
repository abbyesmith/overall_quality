...
const DemoProduct = (props) => {
    ...
    useDocTitle('Overall Quality Construction | Request a Free Quote')
                ...
                <div className="container mx-auto my-8 px-4 lg:px-20" data-aos="zoom-in">
                    <form onSubmit={sendEmail} id="demoProductForm">
                        <div className="w-full bg-white p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
                            <div className="flex">
                                <h1 className="font-bold text-center lg:text-left text-blue-900 uppercase text-4xl">Request a Free Quote</h1>
                            </div>
                            <div className="flex items-center my-4">
                                ...
                                />
                                <label htmlFor="checkbox-1" className="ml-3 text-lg font-medium text-gray-900">Fencing</label>
                            </div>
                            <div className="flex items-center my-4">
                                <input 
                                    id="checkbox-1" 
                                    ...
                                    />
                                <label htmlFor="checkbox-1" className="ml-3 text-lg font-medium text-gray-900">Deck</label>
                            </div>
                            <div className="flex items-center my-4">
                                <input 
                                    id="checkbox-1" 
                                ...
                                />
                                <label htmlFor="checkbox-1" className="ml-3 text-lg font-medium text-gray-900">Interior Remodeling</label>
                            </div>
                            <div className="flex items-center my-4">
                                <input 
                                    id="checkbox-1" 
                                ...
                                />
                                <label htmlFor="checkbox-1" className="ml-3 text-lg font-medium text-gray-900">Other</label>
                            </div>
                            {errors && 
                    ...
                    <div className="flex flex-col text-white">
                        ...
                        <div className="flex my-4 w-2/3 lg:w-3/4">
                            ...
                            <div className="flex flex-col">
                                <h2 className="text-2xl">Headquarters</h2>
                    ...
                    <div className="flex my-4 w-2/3 lg:w-1/2">
                        ...
                        <p className="text-gray-400">999-999-9999</p>
